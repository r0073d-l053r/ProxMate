...
Both selections are also offered as a step in the first-time **setup wizard**, and a searchable snippet **picker** lets you inspect or copy the exact cloud-init code ProxMate writes.
