 ...
 * places doing `console.error('...', err)`, so any Proxmox failure could otherwise
 * write the Authorization header into the log. This test guards that redaction at the
 * client keeps the credential out of the serialized error object.
 *
