    ...
    <Card className="mb-6">
      ...
      <CardContent className="grid gap-4">
        ...
        <FormField
          ...
          hint="The infrastructure address the per-VM firewall pinhole admits to each guest's IDE port — usually the ProxMate host or the subnet-router node, e.g. 192.168.1.228/32. Leave empty on a flat network with isolation off."
        >
          <div className="flex gap-2">
            <Input
              ...
              placeholder="e.g. 192.168.1.228/32"
              className="font-mono"
            />
            <Button
              type="button"
